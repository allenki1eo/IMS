...
const PERMISSIONS = [
  ...
  { module: "warehouse", resource: "issue", action: "read", description: "View store issues and returns" },
  { module: "warehouse", resource: "issue", action: "create", description: "Issue items to production / record returns" },
  // Transport
  ...
  { module: "transport", resource: "trip", action: "delete", description: "Delete trip orders" },
  ...
  { module: "dispatch", resource: "product", action: "read", description: "View finished goods products" },
  { module: "dispatch", resource: "product", action: "create", description: "Create finished goods products" },
  { module: "dispatch", resource: "product", action: "update", description: "Edit finished goods products" },
  { module: "dispatch", resource: "product", action: "delete", description: "Delete finished goods products" },
  { module: "dispatch", resource: "lot", action: "read", description: "View finished goods inventory lots" },
  { module: "dispatch", resource: "lot", action: "create", description: "Receive finished goods inventory lots" },
  { module: "dispatch", resource: "lot", action: "update", description: "Edit finished goods inventory lots" },
  { module: "dispatch", resource: "lot", action: "delete", description: "Delete finished goods inventory lots" },
  { module: "dispatch", resource: "order", action: "read", description: "View dispatch orders" },
  { module: "dispatch", resource: "order", action: "create", description: "Create dispatch orders" },
  { module: "dispatch", resource: "order", action: "update", description: "Edit dispatch orders" },
  { module: "dispatch", resource: "order", action: "delete", description: "Delete dispatch orders" },
  { module: "dispatch", resource: "order", action: "dispatch", description: "Dispatch orders" },
  { module: "dispatch", resource: "order", action: "deliver", description: "Mark dispatch orders delivered" },
  { module: "dispatch", resource: "report", action: "read", description: "View dispatch reports" },
  // Finance
  ...
  // Cashbook
  { module: "finance", resource: "cashbook", action: "read", description: "View cashbook entries" },
  { module: "finance", resource: "cashbook", action: "write", description: "Create/delete cashbook entries" },
  { module: "finance", resource: "cashbook", action: "director", description: "View cross-company cashbook director summary" },
  // Tally Integration
...
const ROLES = [
  ...
  { name: "Director", code: "DIRECTOR", description: "Executive director — full finance visibility and cross-company reporting", isSystemRole: true },
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  COMPANY_ADMIN: [
    ...
    "warehouse:issue:read", "warehouse:issue:create",
    ...
    "transport:trip:read", "transport:trip:create", "transport:trip:update", "transport:trip:dispatch", "transport:trip:complete", "transport:trip:delete",
    ...
    "qc:report:read",
    "dispatch:product:read", "dispatch:product:create", "dispatch:product:update", "dispatch:product:delete",
    "dispatch:lot:read", "dispatch:lot:create", "dispatch:lot:update", "dispatch:lot:delete",
    "dispatch:order:read", "dispatch:order:create", "dispatch:order:update", "dispatch:order:delete", "dispatch:order:dispatch", "dispatch:order:deliver",
    ...
    "finance:cashbook:read", "finance:cashbook:write", "finance:cashbook:director",
    "finance:report:read",
  ...
  BRANCH_MANAGER: [
    ...
    "finance:cashbook:read", "finance:cashbook:write",
    "finance:report:read",
  ...
  MANAGEMENT: [
    ...
    "warehouse:item:read", "warehouse:uom:read", "warehouse:category:read",
    "warehouse:stock:read",
    "warehouse:grn:read", "warehouse:transfer:read", "warehouse:adjustment:read", "warehouse:issue:read",
    ...
    "finance:cashbook:read", "finance:cashbook:director",
    "finance:report:read",
    "analytics:dashboard:read", "analytics:operations:read", "analytics:financial:read",
    "reports:report:read",
    "tra-stamps:stamp:read",
  ...
  DIRECTOR: [
    ...
    "users:user:read",
    "audit:log:read",
    "approvals:request:read", "approvals:request:approve",
    // Full finance read + director cashbook
    "finance:account:read",
    "finance:journal:read",
    "finance:bank:read",
    "finance:payment:read",
    ...
    "finance:report:read",
    "finance:tally:read",
    // Cross-module read for executive oversight
    "warehouse:warehouse:read", "warehouse:item:read", "warehouse:stock:read",
    "warehouse:grn:read", "warehouse:transfer:read",
    "transport:vehicle:read", "transport:trip:read",
    "fuel:tank:read", "fuel:receipt:read", "fuel:issue:read", "fuel:report:read",
    "maintenance:workorder:read", "maintenance:report:read",
    "procurement:supplier:read", "procurement:request:read", "procurement:order:read", "procurement:report:read",
    "production:line:read", "production:recipe:read", "production:batch:read", "production:report:read",
    "qc:standard:read", "qc:test:read", "qc:ncr:read", "qc:report:read",
    "dispatch:product:read", "dispatch:lot:read", "dispatch:order:read", "dispatch:report:read",
    "cotton:season:read", "cotton:bale:read", "cotton:lot:read",
    "cotton:buyer:read", "cotton:contract:read", "cotton:invoice:read",
    "analytics:dashboard:read", "analytics:operations:read", "analytics:financial:read",
    "reports:report:read",
