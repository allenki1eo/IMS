...
import { approvePurchaseRequest } from "@/modules/procurement/requests.service";
...
export async function POST(
  ...
  try {
    const updated = await approvePurchaseRequest(companyId, id, auth.user.id, auth.user.fullName, ipAddress);
