    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Goods Receipt (GRN)", href: "/warehouse/grn", icon: <ClipboardList className="h-4 w-4" />, permission: "warehouse:grn:read" },
          ...
          { label: "Units (UOM)", href: "/warehouse/uom", icon: <Layers className="h-4 w-4" />, permission: "warehouse:uom:read" },
